...
# Source: https://github.com/TU-CCDC-2022/TU-CCDC-2022/blob/main/Linux/harden/check_ssh_config.sh
#
...
find / -xdev -perm +o=w ! \( -type f -perm +o=t \) ! -type l -print 2>/dev/null

BLUE "Checking for world-writable directories... remove these if found!"
find / -xdev -perm +o=w ! \( -type d -perm +o=t \) ! -type l -print 2>/dev/null
